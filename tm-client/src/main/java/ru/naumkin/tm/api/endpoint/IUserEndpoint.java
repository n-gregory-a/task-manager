...
public interface IUserEndpoint {
    ...
    public java.util.List<ru.naumkin.tm.api.endpoint.UserDTO> findAllUsers()
;
    ...
    public void mergeUser(
        ...
        java.lang.String arg0,
        @WebParam(name = "arg1", targetNamespace = "")
        ru.naumkin.tm.api.endpoint.UserDTO arg1
    ) throws Exception;
    ...
    @WebResult(name = "return", targetNamespace = "")
    public ru.naumkin.tm.api.endpoint.UserDTO findOneUser(
    ...
    public void persistUser(
        ...
        @WebParam(name = "arg0", targetNamespace = "")
        ru.naumkin.tm.api.endpoint.UserDTO arg0
    );
