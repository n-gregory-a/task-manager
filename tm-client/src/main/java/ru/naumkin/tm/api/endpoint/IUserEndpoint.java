...
public interface IUserEndpoint {
    ...
    @WebMethod
    @Action(input = "http://endpoint.api.tm.naumkin.ru/IUserEndpoint/removeAllUserRequest", output = "http://endpoint.api.tm.naumkin.ru/IUserEndpoint/removeAllUserResponse", fault = {@FaultAction(className = SQLException_Exception.class, value = "http://endpoint.api.tm.naumkin.ru/IUserEndpoint/removeAllUser/Fault/SQLException")})
    ...
    @WebMethod
    @Action(input = "http://endpoint.api.tm.naumkin.ru/IUserEndpoint/findAllUsersRequest", output = "http://endpoint.api.tm.naumkin.ru/IUserEndpoint/findAllUsersResponse", fault = {@FaultAction(className = SQLException_Exception.class, value = "http://endpoint.api.tm.naumkin.ru/IUserEndpoint/findAllUsers/Fault/SQLException")})
 ...
 throws SQLException_Exception;
    ...
    @WebMethod
    @Action(input = "http://endpoint.api.tm.naumkin.ru/IUserEndpoint/mergeUserRequest", output = "http://endpoint.api.tm.naumkin.ru/IUserEndpoint/mergeUserResponse", fault = {@FaultAction(className = SQLException_Exception.class, value = "http://endpoint.api.tm.naumkin.ru/IUserEndpoint/mergeUser/Fault/SQLException")})
    ...
    @WebMethod
    @Action(input = "http://endpoint.api.tm.naumkin.ru/IUserEndpoint/findOneUserRequest", output = "http://endpoint.api.tm.naumkin.ru/IUserEndpoint/findOneUserResponse", fault = {@FaultAction(className = SQLException_Exception.class, value = "http://endpoint.api.tm.naumkin.ru/IUserEndpoint/findOneUser/Fault/SQLException")})
    ...
    @WebMethod
    @Action(input = "http://endpoint.api.tm.naumkin.ru/IUserEndpoint/persistUserRequest", output = "http://endpoint.api.tm.naumkin.ru/IUserEndpoint/persistUserResponse", fault = {@FaultAction(className = SQLException_Exception.class, value = "http://endpoint.api.tm.naumkin.ru/IUserEndpoint/persistUser/Fault/SQLException")})
    ...
    @WebMethod
    @Action(input = "http://endpoint.api.tm.naumkin.ru/IUserEndpoint/removeUserRequest", output = "http://endpoint.api.tm.naumkin.ru/IUserEndpoint/removeUserResponse", fault = {@FaultAction(className = SQLException_Exception.class, value = "http://endpoint.api.tm.naumkin.ru/IUserEndpoint/removeUser/Fault/SQLException")})
